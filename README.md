...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/mapshader-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12771&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/mapshader-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `mapshader` can be installed with:

```
conda install mapshader
```

It is possible to list all of the versions of `mapshader` available on your platform with:
